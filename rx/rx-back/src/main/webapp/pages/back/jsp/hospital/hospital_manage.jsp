					...
					<div class="tabs-container" id="tabs-243687">
						<ul class="nav nav-tabs" id="top_tab">
							<li class="active" onclick="javascript:resetFun();"><a data-toggle="tab" href="#tab-1"
								aria-expanded="true">医院信息列表</a></li>
							<li class="hide" id="edit-hospital-li"><a
									...
									<div class="row clearfix">
										<div class="col-md-12 column">
											<div class="panel panel-default">
												...
												<div class="panel panel-default">
													<div class="panel-body">
														<button type="button" class="btn btn-default btn-primary" id="add-hospital-btn">添加医院信息</button>
													</div>
												</div>
												<div class="panel panel-default">
													<div class="panel-body">
														<div id="item-div" style="margin: 20px">
															<%@ include file="hospital_table.jsp"%>
														</div>
													</div>
												</div>
												</div>
											...
											<div class="panel panel-default">
												...
												<div class="panel-body">
													<form class="form-horizontal" id="save-form">
														<input type="hidden" id="hospital-id" name="id" value="" />
														<div class="form-group">
															<label class="col-sm-2 control-label">编码</label>
															<div class="col-sm-10">
																<input type="text" id="hospital-code" name="code"
														...
														<div class="form-group">
															...
															<div class="col-md-10">
																<input type="text" id="hospital-name" name="name"
														...
														<div class="form-group">
															...
															<div class="col-md-10">
																<input type="text" id="hospital-comment" name="comment"
