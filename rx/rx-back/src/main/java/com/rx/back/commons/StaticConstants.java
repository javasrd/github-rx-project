...
public class StaticConstants {
	...
	public static String USER_MANAGE_PAGE = "back/jsp/user/user_manage";//用户管理页面
	public static String USER_MANAGE_TABLE_PAGE = "back/jsp/user/user_table";//用户管理列表页面
	
	public static String ROLE_MANAGE_PAGE = "back/jsp/role/role_manage";//角色管理页面
	...
	public static String DICT_COMMON_MANAGE_PAGE = "back/jsp/dict_common/dict_common_manage";//接口信息维护页面
	public static String DICT_COMMON_MANAGE_TABLE_PAGE = "back/jsp/dict_common/dict_common_table";//接口信息维护列表页面
	
	public static String DISPENSARY_MANAGE_PAGE = "back/jsp/dispensary/dispensary_manage";//药房信息维护页面
	public static String DISPENSARY_MANAGE_TABLE_PAGE = "back/jsp/dispensary/dispensary_table";//药房信息维护列表页面
	
	public static String HOSPITAL_MANAGE_PAGE = "back/jsp/hospital/hospital_manage";//医院信息维护页面
	public static String HOSPITAL_MANAGE_TABLE_PAGE = "back/jsp/hospital/hospital_table";//医院信息维护列表页面
