...
public class RequestResultUtil {
	...
	public static Map<String, Object> getResultSelectWarn(){
		respMap.clear();
		respMap.put(RESULT_CODE, RESULT_CODE_FAIL);
		respMap.put(RESULT_ERR_MSG, RESULT_SELECT_WARN);
		return respMap;
	}
	/**
	 * 方法功能：获取添加成功结果集
	...
	public static Map<String, Object> getResultAddWarn(){
		respMap.clear();
		respMap.put(RESULT_CODE, RESULT_CODE_FAIL);
		respMap.put(RESULT_ERR_MSG, RESULT_ADD_WARN);
		return respMap;
	}
	...
	public static Map<String, Object> getResultSaveWarn(){
		respMap.clear();
		respMap.put(RESULT_CODE, RESULT_CODE_FAIL);
		respMap.put(RESULT_ERR_MSG, RESULT_SAVE_WARN);
		return respMap;
	}
	...
	public static Map<String, Object> getResultUpdateWarn(){
		respMap.clear();
		respMap.put(RESULT_CODE, RESULT_CODE_FAIL);
		respMap.put(RESULT_ERR_MSG, RESULT_UPDATE_WARN);
		return respMap;
	}
	...
	public static Map<String, Object> getResultDeleteWarn(){
		respMap.clear();
		respMap.put(RESULT_CODE, RESULT_CODE_FAIL);
		respMap.put(RESULT_ERR_MSG, RESULT_DELETE_WARN);
		return respMap;
	}
	...
	public static Map<String, Object> getResultUploadWarn(){
		respMap.clear();
		respMap.put(RESULT_CODE, RESULT_CODE_FAIL);
		respMap.put(RESULT_ERR_MSG, RESULT_UPLOAD_WARN);
		return respMap;
	}
	...
	public static Map<String, Object> getResultUploadFileEmpty(){
		respMap.clear();
		respMap.put(RESULT_CODE, RESULT_CODE_FAIL);
		respMap.put(RESULT_ERR_MSG, RESULT_UPLOAD_FILE_EMPTY);
		return respMap;
	}
	...
	public static Map<String, Object> getResultUploadFileDeleteSuccess(){
		respMap.clear();
		respMap.put(RESULT_CODE, RESULT_CODE_FAIL);
		respMap.put(RESULT_ERR_MSG, RESULT_UPLOAD_FILE_DELETE_SUCCESS);
		return respMap;
	}
	...
	public static Map<String, Object> getResultUploadFileDeleteWarn(){
		respMap.clear();
		respMap.put(RESULT_CODE, RESULT_CODE_FAIL);
		respMap.put(RESULT_ERR_MSG, RESULT_UPLOAD_FILE_DELETE_WARN);
		return respMap;
	}
