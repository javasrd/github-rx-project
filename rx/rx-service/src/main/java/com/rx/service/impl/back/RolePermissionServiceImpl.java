...
import com.rx.dao.RolePermissionMapper;
...
public class RolePermissionServiceImpl extends AbstractBaseService<RolePermission, Long> implements IRolePermissionService {
	...
	/**
	 * @see com.rx.service.back.IRolePermissionService#getByRoleId(java.lang.Long)
	...
	/**
	 * @see com.rx.service.back.IRolePermissionService#deleteByRoleId(java.lang.Long)
	...
	/**
	 * @see com.rx.service.back.IRolePermissionService#getByRoleIds(java.util.List)
	...
	/**
	 * @see com.rx.service.back.IRolePermissionService#deleteByPermissionId(java.lang.Long)
	 * 根据菜单权限删除 角色权限关系表
	 */
	@Override
