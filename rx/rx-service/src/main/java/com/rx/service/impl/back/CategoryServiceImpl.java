...
import com.rx.dao.CategoryMapper;
import com.rx.entity.Category;
import com.rx.entity.CategoryBrand;
import com.rx.service.back.ICategoryBrandService;
import com.rx.service.back.ICategoryService;
...
public class CategoryServiceImpl extends AbstractBaseService<Category, Long> implements ICategoryService {
	...
	/**
	 * @see com.rx.service.back.ICategoryService#selectByLev(int)
	 * 根据级别查询类目
	 */
	@Override
	...
	/**
	 * @see com.rx.service.back.ICategoryService#getAll(java.lang.String)
	...
	/**
	 * @see com.rx.service.back.ICategoryService#updateById(com.rx.entity.Category)
