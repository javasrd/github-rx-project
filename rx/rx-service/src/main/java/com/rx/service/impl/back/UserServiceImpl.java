...
public class UserServiceImpl extends AbstractBaseService<User, Long> implements IUserService {
	...
	/**
	 * @see com.rx.service.back.IUserService#logicDelById(java.lang.Long)
	 * 逻辑删除用户，物理删除用户角色关系
	 */
	@Override
	@Transactional
	...
	/**
	 * @see com.rx.service.back.IUserService#getList(java.util.Map)
	 * 查询未删除的用户
	...
	/**
	 * @see com.rx.service.back.IUserService#add(com.rx.entity.User, java.lang.String)
	 * 添加用户和用户角色
	 */
	@Override
	@Transactional
	...
	/**
	 * @see com.rx.service.back.IUserService#modify(com.rx.entity.User, java.lang.String)
	 * 修改用户和用户角色
	 */
	@Override
	@Transactional
	...
	/**
	 * @see com.rx.service.back.IUserService#getMenuPermissionListByUserId(java.lang.Long)
	 * 根据用户ID查询菜单权限
	 */
	@Override
