...
import com.rx.dao.CategoryBrandMapper;
...
public class CategoryBrandServiceImpl extends AbstractBaseService<CategoryBrand, Long> implements ICategoryBrandService {
	...
	/**
	 * @see com.rx.service.back.ICategoryBrandService#saveCategoryBrand(java.util.List)
	 * 保存类目品牌
	 */
	@Override
	@Transactional
	...
	/**
	 * @see com.rx.service.back.ICategoryBrandService#deleteByThirdLevCid(java.lang.Long)
	 * 根据三级类目ID删除
	 */
	@Override
